...
public class Cadastro {
    public static File arquivo = new File("dados_usuario.txt");
    ...
    public static void dadosCliente() throws ParseException {
        ...
        while (true) {
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                if (confimesenha != senha) {
                    JOptionPane.showConfirmDialog(null, null, "confirme sua senha corretamente",
