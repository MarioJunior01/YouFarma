...
public class Produtos {
    ...
    public static void adicionarDermocosmeticos() {
        ...
        adicionarProduto("Sérum facial Vitamina C", 37.99);
        adicionarProduto("Sabonete facial Vichy 45ml", 40.99);
        adicionarProduto("Protetor solar facial fps60", 35.00);
        adicionarProduto("Esfoliante corporal", 20.00);
        adicionarProduto("Hidartante facial", 26.50);
        adicionarProduto("Sérum anti-idade La roche", 70.00);
    ...
    public static void adicionarSaudeBeleza() {
        ...
        adicionarProduto("Escova de dentes", 25.99);
        adicionarProduto("Termômetro", 23.99);
        adicionarProduto("Band-aid infantil 24 unidades", 15.00);
        adicionarProduto("Lenços de papel, 20 unidades", 20.90);
        adicionarProduto("Desodorante aerosol 30g", 25.00);
        adicionarProduto("Pasta de dente infantil", 17.80);
        ...
        while (true) {
            ...
            if (elementoAdd >= 0 && elementoAdd < listaDeProdutos.size()) {
                ...
                for (Map.Entry<String, Double> entry : produtosSelecionados.entrySet()) {
                    ...
                    carrinho.adicionarProduto(produtoSelecionado, precoProdutoSelecionado);
