...
//tipos de pagamento online e presencial (Pagamento por PIX, cartão de débito/crédito, dinheiro)
//taxa de entrega,
//reembolso e devolução,
//confirmação de pedido ao cliente, incluindo os detalhes da compra, o número de transação e informações de contato.
