...
public class Produtos {
    ...
    public static void adicionarMedicamentos() {
        resetaLista(); // deixa a lista de produtos vazia
        ...
        while (true) {
            ...
            if (elementoAdd >= 0 && elementoAdd < listaDeProdutos.size()) {
                ...
                if (continuarComprando == JOptionPane.YES_OPTION) {
                    return true; //retornar true no método onde foi chamado, no caso o da clásse farmácia
                }
            } else {
    ...
    public static void resetaLista(){
